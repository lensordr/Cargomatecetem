...
const translations = {
    en: {
        ...
        'about-company-desc': 'CargoMate Cetem SL is an international road transport company built on a family heritage of over three decades in European freight operations, with a strong specialization in tautliner-based road transport.',
        'about-heritage-title': 'Our Heritage',
        'about-heritage-desc': 'Our family has been active in the road transportation sector since 1991, developing deep operational expertise and a reputation for reliability across major European routes. Founded as a second-generation initiative, CargoMate represents the evolution of that legacy—combining established industry know-how with a modern, technology-driven approach to logistics and transport management.',
        'about-approach-title': 'Our Approach',
        'about-approach-desc': 'We operate as a modern logistics partner, integrating digital tools, structured workflows, and data-informed decision-making into every stage of the transport process. This enables us to deliver efficient, transparent, and dependable transport solutions for our clients.',
        'about-values-title': 'Our Values',
        'value-1': 'Reliability and operational discipline',
        'value-2': 'Clear communication and transparency',
        'value-3': 'Long-term partnerships built on trust',
        'value-4': 'Continuous improvement and adaptability',
        'about-future-title': 'Looking Ahead',
        'about-future-desc': 'CargoMate aims to grow as an independent transport company while contributing to the long-term development of the broader family business ecosystem—maintaining the standards and values that have shaped our operations for more than 30 years.',
    ...
    es: {
        ...
        'about-company-desc': 'CargoMate Cetem SL es una empresa de transporte internacional por carretera basada en una trayectoria familiar de más de tres décadas en el transporte de mercancías en Europa, con una sólida especialización en transporte mediante tautliner.',
        'about-heritage-title': 'Nuestra Trayectoria',
        'about-heritage-desc': 'Nuestra familia está vinculada al sector del transporte por carretera desde 1991, acumulando una amplia experiencia operativa y una reputación de fiabilidad en las principales rutas europeas. CargoMate nace como una iniciativa de segunda generación, combinando el conocimiento tradicional del sector con una visión moderna y orientada a la tecnología.',
        'about-approach-title': 'Nuestro Enfoque',
        'about-approach-desc': 'Actuamos como un socio logístico moderno, integrando herramientas digitales, procesos estructurados y decisiones basadas en datos en cada fase del transporte.',
        'about-values-title': 'Nuestros Valores',
        'value-1': 'Fiabilidad y disciplina operativa',
        'value-2': 'Comunicación clara y transparencia',
        'value-3': 'Relaciones a largo plazo basadas en la confianza',
        'value-4': 'Mejora continua y capacidad de adaptación',
        'about-future-title': 'Mirando al Futuro',
        'about-future-desc': 'CargoMate aspira a crecer como empresa independiente y a contribuir al desarrollo a largo plazo del ecosistema empresarial familiar, manteniendo los valores que han definido nuestra actividad durante más de 30 años.',
    ...
    ro: {
        ...
        'about-company-title': 'Compania Noastră',
        'about-company-desc': 'CargoMate Cetem SL este o companie de transport rutier internațional construită pe o tradiție de familie de peste 30 de ani în transportul de marfă în Europa, cu o specializare puternică în transportul cu tautliner.',
        'about-heritage-title': 'Moștenirea Noastră',
        'about-heritage-desc': 'Familia noastră activează în domeniul transporturilor rutiere din 1991, acumulând experiență operațională solidă și construind relații bazate pe încredere pe principalele rute europene. CargoMate reprezintă evoluția acestei moșteniri, ca inițiativă de generația a doua, îmbinând experiența tradițională cu o viziune modernă.',
        'about-approach-title': 'Abordarea Noastră',
        'about-approach-desc': 'Acționăm ca un partener logistic modern, integrând instrumente digitale, procese clare și decizii bazate pe date în fiecare etapă a transportului.',
        'about-values-title': 'Valorile Noastre',
        'value-1': 'Fiabilitate și disciplină operațională',
        'value-2': 'Comunicare clară și transparență',
        'value-3': 'Parteneriate pe termen lung',
        'value-4': 'Îmbunătățire continuă și adaptabilitate',
        'about-future-title': 'Privind Spre Viitor',
        'about-future-desc': 'CargoMate își propune să se dezvolte ca operator independent și să contribuie la evoluția pe termen lung a afacerii de familie, menținând valorile care ne definesc de peste 30 de ani.',
